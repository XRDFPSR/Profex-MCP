...
#ifndef GAUSSIANCURVE_H
#define GAUSSIANCURVE_H
...
class XRDIO_EXPORT GaussianCurve : public GenericCurve
{
public:
    GaussianCurve();
    ...
    inline CurveType type() const {return GAUSSIAN;}

    static inline QString descriptionStatic() {return "Gaussian";}
    static inline QString equationTextStatic() {return QString("f(x) = c exp(-log(2) ((x-a) / b)^2)");}

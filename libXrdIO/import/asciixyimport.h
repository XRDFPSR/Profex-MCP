...
#ifndef ASCIIXYIMPORT_H
#define ASCIIXYIMPORT_H
...
class XRDIO_EXPORT AsciiXyImport : public GenericImport
{
    public:
        AsciiXyImport(QObject * = 0);

        bool isSupported(const QByteArray &);
        int load(const QString &, QVector<Scan> &, bool minimal = false);
        QString uniqueId() {return "ASCII_XY";}
};
#endif // ASCIIXYIMPORT_H
